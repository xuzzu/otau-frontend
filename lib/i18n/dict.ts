...
const kz: Dict = {
  ...
  "login.title": "Аккаунтыңызға кіріңіз",
  "login.tab.email": "Email",
  "login.tab.phone": "Телефон",
  "login.email.placeholder": "сіз@example.com",
  "login.phone.placeholder": "+7 700 000 0000",
  "login.send_code": "Кодты жіберу",
  "login.code.title": "{to} мекенжайына жіберілген кодты енгізіңіз",
  "login.code.placeholder": "6 таңбалы код",
  "login.verify": "Растау",
  "login.resend": "Қайта жіберу",
  "login.dev_code": "Дев код: {code}",
  "login.error.invalid": "Код қате — қайта көріңіз",
  "login.error.generic": "Сұрау сәтсіз. Қайта көріңіз.",
  "login.success": "Сіз кірдіңіз",
  ...
  // studio canvas
  "studio.lighting.cozy": "Жайлы",
  "studio.lighting.minimal": "Минимал",
  "studio.lighting.evening": "Кеш",
  "studio.styles_label": "Стильдер",
  "studio.concept_label": "Концепция",
  "studio.tooltip.cycle_lighting": "Жарықты ауыстыру",
  "studio.tooltip.concept": "Концепцияны қарау немесе өзгерту",
  "studio.tooltip.regenerate": "Бұл бөлмені қайта рендерлеу",
  "studio.tooltip.add_item": "Бөлмеге зат қосу",
  ...
  "studio.alert.add_pending": "Зат қосу — әлі қосылмаған.",
  "studio.alert.replace_pending": "Ауыстыру — басқа кандидатты таңдау. Әлі қосылмаған.",
...
const ru: Dict = {
  ...
  "login.tab.email": "Email",
  "login.tab.phone": "Телефон",
  "login.email.placeholder": "вы@example.com",
  "login.phone.placeholder": "+7 700 000 0000",
  "login.send_code": "Отправить код",
  "login.code.title": "Введите код, отправленный на {to}",
  "login.code.placeholder": "6-значный код",
  "login.verify": "Подтвердить",
  "login.resend": "Отправить снова",
  "login.dev_code": "Дев-код: {code}",
  "login.error.invalid": "Неверный код — попробуйте ещё раз",
  ...
  // studio canvas
  "studio.lighting.cozy": "Уют",
  "studio.lighting.minimal": "Минимал",
  "studio.lighting.evening": "Вечер",
  "studio.styles_label": "Стили",
  "studio.concept_label": "Концепция",
  "studio.tooltip.cycle_lighting": "Сменить освещение",
  "studio.tooltip.concept": "Просмотреть или изменить концепцию",
  "studio.tooltip.regenerate": "Перерендерить эту комнату",
  "studio.tooltip.add_item": "Добавить предмет в эту комнату",
  ...
  "studio.alert.add_pending": "Выбор предмета — пока не подключено.",
  "studio.alert.replace_pending": "Замена — выбор другого кандидата. Пока не подключено.",
