...
import { resolveCatalogAsset, resolveGenerationAsset } from "@/lib/api/env";
import type {
  GenerationRoom,
  ItemSummary,
} from "@/lib/api/types";
    ...
    >
      ...
      >
        ...
        >
          ...
          <SceneViewport genRoom={activeGenRoom} />
...
function SceneViewport({
  ...
  if (status === "failed") {
    return (
      <div style={{ ...SCENE_BOX, borderColor: "#c9694a", padding: 32 }}>
  ...
  return (
    <div style={{ ...SCENE_BOX, flexDirection: "column", gap: 18 }}>
      <motion.div
        animate={{ rotate: 360 }}
